...
<body>
  ...
  <div class="container">
    <div class="row">
      <div class="col-4 offset-md-4 form-div login">
        <form class="" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
          ...
          <div class="form-group">
            ...
            <input type="password" name="password" value="<?php echo $password; ?>" placeholder="Enter Password" class="form-control form-control-lg" required>
          </div>

          <div class="form-group">
            <button type="submit" name="login-btn" class="btn btn-primary btn-block btn-lg">Login</button>
          </div>
          <p class="text-center">Don't have an account? <a href="<?php ROOT_URL; ?>signup.php">Sign Up</a></p>
        </form>
      </div>
    </div>
